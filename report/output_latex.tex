...
\fancyhead[C]{%
          ...
          \includegraphics[width=2.5cm]{report/images/artic_boa_logo.pdf}
          \end{tabular} &
          \begin{minipage}[f]{10.7cm}
            \raggedleft{\large \itshape \textcolor{rodeo_grey}{knekro} \\ \scriptsize{RESULTADOS DE LA RETRANSMISION}} \end{minipage}
           & \begin{tabular}[f]{f{1cm}}
            \includegraphics[width=1cm]{report/images/knekro_profile.jpg}
            \end{tabular}
          \end{tabular}%
          \hline
}
...
\begin{document}
\section*{Sunday, 28 de November de 2021}
\begin{figure}[H]
   \centering
   \includegraphics[width=0.200000\textwidth,left]{report/images/knekro_profile.jpg}
   \caption*{ }
   \end{figure}
\begin{figure}[H]
   \centering
   \includegraphics[width=1.000000\textwidth,left]{data/knekro_2021_11_29.pdf}
