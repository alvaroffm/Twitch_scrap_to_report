...
\fancyhead[C]{%
          ...
          \begin{minipage}[f]{10.7cm}
            \raggedleft{\large \itshape \textcolor{rodeo_grey}{elxokas} \\ \scriptsize{BROADCAST STATS}} \end{minipage}
           & \begin{tabular}[f]{f{1cm}}
            \includegraphics[width=1cm]{report/images/elxokas_profile.jpg}
            \end{tabular}
          \end{tabular}%
          \hline
}
