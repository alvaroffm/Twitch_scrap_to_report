...
\fancyhead[C]{%
          ...
          \begin{minipage}[f]{10.7cm}
            \raggedleft{\large \itshape \textcolor{rodeo_grey}{auronplay} \\ \scriptsize{RESULTADOS DE LA RETRANSMISION}} \end{minipage}
           & \begin{tabular}[f]{f{1cm}}
            \includegraphics[width=1cm]{report/images/auronplay_profile.jpg}
            \end{tabular}
          \end{tabular}%
          \hline
}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.200000\textwidth]{report/images/auronplay_profile.jpg}
   \caption*{ }
   \end{figure}
\begin{figure}[H]
   \centering
